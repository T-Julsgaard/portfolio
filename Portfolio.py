...
def build_website():
    ...
    <body class="bg-stone-50 text-stone-900 pt-20">
        ...
        <main class="max-w-6xl mx-auto px-6">
            ...
            <section class="pt-0 md:pt-2 pb-10">
                <div class="flex justify-between items-end mb-12 md:mb-20 reveal border-b border-stone-200 pb-8">
        ...
        <main class="flex-grow flex items-center justify-center px-6 py-10 md:py-20 overflow-hidden">
            <div class="max-w-6xl w-full reveal">
                <div class="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
                    <div>
                        <p class="font-mono text-teal-600 mb-4 md:mb-6 tracking-widest uppercase">Contact</p>
