        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {{
                ...
                if(btn && container) {{
                    ...
                    // 1. Proximity Sensor (Desktop Hover)
                    ...
                    // 2. Click/Tap Handler (Works for both Mobile Taps and Desktop Clicks)
                    // We prevent default so it doesn't actually 'click', it just runs away
                    const runAway = (e) => {{
                        e.preventDefault();
                        // For touch events, we might need the first touch point
